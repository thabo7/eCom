...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "nkositexcellent@gmail.com", ZipCode = "5100" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("nkositexcellent@gmail.com", "Forms"), null);
